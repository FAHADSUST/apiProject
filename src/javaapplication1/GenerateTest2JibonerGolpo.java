...
//    
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        try {
            ...
            InputStream fis = new FileInputStream("jiboner_golpo/Jiboner_Golpo.txt");
        ...
        DateTime startDate = new DateTime(2017, 8, 17, 0, 0, 0, 0);//pattern.parseDateTime(start); // year-month-day
        ...
        File file = new File("jiboner_golpo/filename_jiboner_golpo.txt");
